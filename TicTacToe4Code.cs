...
public class TicTacToeL4Code : MonoBehaviour
{
    Boolean checker;
    int plusone;
    ...
    public void score()
    {
        if (btnText1.text == "X" && btnText2.text == "X" && btnText3.text == "X" && btnText4.text == "X" && btnText5.text == "X" && btnText6.text == "X")
        {
        ...
        if (btnText7.text == "X" && btnText8.text == "X" && btnText9.text == "X" && btnText10.text == "X" && btnText11.text == "X" && btnText12.text == "X")
        {
        ...
        if (btnText13.text == "X" && btnText14.text == "X" && btnText15.text == "X" && btnText16.text == "X" && btnText17.text == "X" && btnText18.text == "X")
        {
        ...
        if (btnText19.text == "X" && btnText20.text == "X" && btnText21.text == "X" && btnText22.text == "X" && btnText23.text == "X" && btnText24.text == "X")
        {
        ...
        if (btnText25.text == "X" && btnText26.text == "X" && btnText27.text == "X" && btnText28.text == "X" && btnText29.text == "X" && btnText30.text == "X")
        {
            btnText25.color = Color.cyan;
            btnText26.color = Color.cyan;
            btnText27.color = Color.cyan;
            btnText28.color = Color.cyan;
        ...
        if (btnText31.text == "X" && btnText32.text == "X" && btnText33.text == "X" && btnText34.text == "X" && btnText35.text == "X" && btnText36.text == "X")
        {
            btnText31.color = Color.red;
            btnText32.color = Color.red;
            btnText33.color = Color.red;
        ...
        if (btnText1.text == "X" && btnText7.text == "X" && btnText13.text == "X" && btnText19.text == "X" && btnText25.text == "X" && btnText31.text == "X")
        {
            btnText1.color = Color.cyan;
        ...
        if (btnText2.text == "X" && btnText8.text == "X" && btnText14.text == "X" && btnText20.text == "X" && btnText26.text == "X" && btnText32.text == "X")
        {
        ...
        if (btnText3.text == "X" && btnText9.text == "X" && btnText15.text == "X" && btnText21.text == "X" && btnText27.text == "X" && btnText33.text == "X")
        {
            btnText3.color = Color.cyan;
        ...
        if (btnText4.text == "X" && btnText10.text == "X" && btnText16.text == "X" && btnText22.text == "X" && btnText28.text == "X" && btnText34.text == "X")
        {
        ...
        if (btnText5.text == "X" && btnText11.text == "X" && btnText17.text == "X" && btnText23.text == "X" && btnText29.text == "X" && btnText35.text == "X")
        {
            btnText5.color = Color.cyan;
        ...
        if (btnText6.text == "X" && btnText12.text == "X" && btnText18.text == "X" && btnText24.text == "X" && btnText30.text == "X" && btnText36.text == "X")
        {
        ...
        if (btnText1.text == "X" && btnText8.text == "X" && btnText15.text == "X" && btnText22.text == "X" && btnText29.text == "X" && btnText36.text == "X")
        {
            btnText1.color = Color.cyan;
        ...
        if (btnText6.text == "X" && btnText11.text == "X" && btnText16.text == "X" && btnText21.text == "X" && btnText26.text == "X" && btnText31.text == "X")
        {
            btnText6.color = Color.red;
            btnText11.color = Color.red;
            btnText16.color = Color.red;
        ...
        if (btnText1.text == "O" && btnText2.text == "O" && btnText3.text == "O" && btnText4.text == "O" && btnText5.text == "O" && btnText6.text == "O")
        {
            btnText1.color = Color.cyan;
            btnText2.color = Color.cyan;
            btnText3.color = Color.cyan;
        ...
        if (btnText7.text == "O" && btnText8.text == "O" && btnText9.text == "O" && btnText10.text == "O" && btnText11.text == "O" && btnText12.text == "O")
        {
            btnText7.color = Color.red;
            btnText8.color = Color.red;
            btnText9.color = Color.red;
        ...
        if (btnText13.text == "O" && btnText14.text == "O" && btnText15.text == "O" && btnText16.text == "X" && btnText17.text == "O" && btnText18.text == "O")
        {
            btnText13.color = Color.cyan;
            btnText14.color = Color.cyan;
            btnText15.color = Color.cyan;
        ...
        if (btnText19.text == "O" && btnText20.text == "O" && btnText21.text == "O" && btnText22.text == "O" && btnText23.text == "O" && btnText24.text == "O")
        {
            btnText19.color = Color.red;
            btnText20.color = Color.red;
            btnText21.color = Color.red;
        ...
        if (btnText25.text == "O" && btnText26.text == "O" && btnText27.text == "O" && btnText28.text == "O" && btnText29.text == "O" && btnText30.text == "O")
        {
            btnText25.color = Color.cyan;
            btnText26.color = Color.cyan;
            btnText27.color = Color.cyan;
        ...
        if (btnText31.text == "O" && btnText32.text == "O" && btnText33.text == "O" && btnText34.text == "O" && btnText35.text == "O" && btnText36.text == "O")
        {
            btnText31.color = Color.red;
            btnText32.color = Color.red;
            btnText33.color = Color.red;
        ...
        if (btnText1.text == "O" && btnText7.text == "O" && btnText13.text == "O" && btnText19.text == "O" && btnText25.text == "O" && btnText31.text == "O")
        {
            btnText1.color = Color.cyan;
            btnText7.color = Color.cyan;
            btnText13.color = Color.cyan;
        ...
        if (btnText2.text == "O" && btnText8.text == "O" && btnText14.text == "O" && btnText20.text == "O" && btnText26.text == "O" && btnText32.text == "O")
        {
            btnText2.color = Color.red;
            btnText8.color = Color.red;
            btnText14.color = Color.red;
        ...
        if (btnText3.text == "O" && btnText9.text == "O" && btnText15.text == "O" && btnText21.text == "O" && btnText27.text == "O" && btnText33.text == "O")
        {
            btnText3.color = Color.cyan;
            btnText9.color = Color.cyan;
            btnText15.color = Color.cyan;
        ...
        if (btnText4.text == "O" && btnText10.text == "O" && btnText16.text == "O" && btnText22.text == "O" && btnText28.text == "O" && btnText34.text == "O")
        {
            btnText4.color = Color.red;
            btnText10.color = Color.red;
            btnText16.color = Color.red;
        ...
        if (btnText5.text == "O" && btnText11.text == "O" && btnText17.text == "O" && btnText23.text == "O" && btnText29.text == "O" && btnText35.text == "O")
        {
            btnText5.color = Color.cyan;
            btnText11.color = Color.cyan;
            btnText17.color = Color.cyan;
        ...
        if (btnText6.text == "O" && btnText12.text == "O" && btnText18.text == "O" && btnText24.text == "O" && btnText30.text == "O" && btnText36.text == "O")
        {
            btnText6.color = Color.red;
            btnText12.color = Color.red;
            btnText18.color = Color.red;
        ...
        if (btnText1.text == "O" && btnText8.text == "O" && btnText15.text == "O" && btnText22.text == "O" && btnText29.text == "O" && btnText36.text == "O")
        {
            btnText1.color = Color.cyan;
            btnText8.color = Color.cyan;
            btnText15.color = Color.cyan;
        ...
        if (btnText6.text == "O" && btnText11.text == "O" && btnText16.text == "O" && btnText21.text == "O" && btnText26.text == "O" && btnText31.text == "O")
        {
            btnText6.color = Color.red;
            btnText11.color = Color.red;
            btnText16.color = Color.red;
